...
# Create a base model using pre-trained DenseNet121
...
model_checkpoint = callbacks.ModelCheckpoint("denseNet_model.h5", monitor='val_accuracy', mode='max', save_best_only=True)
...
model=model.load_weights("denseNet_model.h5")
...
sample_image_path = "D:\\Sem-3\\Intro to Python\\Project\\Augmentation\\testImages\\2.jpg"

# Load the image with target size (224, 224) as expected by DenseNet121
...
# Preprocess the image for DenseNet121 model
